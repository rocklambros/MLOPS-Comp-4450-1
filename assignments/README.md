...
| [`hw2`](hw2/) | 2 | 2 | Docker packaging | built |
...
Assignments may be done in pairs. When you pair up, record the partner in the assignment stub and follow the branch-and-PR flow in [`../CONTRIBUTING.md`](../CONTRIBUTING.md) so both partners' work is attributable.

## Deadlines and extensions

Assignments are due end of day Tuesday, one week after release. At most two extensions are allowed across the course, and each must be requested by email before the deadline.
